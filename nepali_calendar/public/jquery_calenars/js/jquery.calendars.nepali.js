...
(function ($) {
  ...
  function NepaliCalendar(language) {
    this.local =
      this.regionalOptions[language || ""] || this.regionalOptions[""];
  }
  ...
  $.extend(NepaliCalendar.prototype, {
    ...
    daysInMonth: function (year, month) {
      ...
      return typeof this.NEPALI_CALENDAR_DATA[year] === "undefined"
        ...
        : this.NEPALI_CALENDAR_DATA[year][month];
    },
    ...
    toJD: function (nepaliYear, nepaliMonth, nepaliDay) {
      ...
      var gregorianYear =
        nepaliYear -
        (nepaliMonthToCheck > 9 ||
        (nepaliMonthToCheck === 9 &&
          nepaliDay >= this.NEPALI_CALENDAR_DATA[nepaliYearToCheck][0])
          ? 56
          : 57);
      ...
      while (nepaliMonthToCheck !== 9) {
        ...
        gregorianDayOfYear +=
          this.NEPALI_CALENDAR_DATA[nepaliYearToCheck][nepaliMonthToCheck];
        nepaliMonthToCheck--;
      }
      ...
      if (nepaliMonth === 9) {
        ...
        gregorianDayOfYear +=
          this.NEPALI_CALENDAR_DATA[nepaliYearToCheck][9] -
          this.NEPALI_CALENDAR_DATA[nepaliYearToCheck][0];
      }
      return gregorianCalendar
        .newDate(gregorianYear, 1, 1)
        .add(gregorianDayOfYear, "d")
        .toJD();
    },
    ...
    fromJD: function (jd) {
      ...
      var daysSinceJanFirstToEndOfNepaliMonth =
        this.NEPALI_CALENDAR_DATA[nepaliYear][nepaliMonth] -
        dayOfFirstJanInPaush +
        1;
    ...
    _createMissingCalendarData: function (nepaliYear) {
      ...
      for (
        var nepaliYearToCreate = nepaliYear - 1;
        nepaliYearToCreate < nepaliYear + 2;
        nepaliYearToCreate++
      ) {
        if (
          typeof this.NEPALI_CALENDAR_DATA[nepaliYearToCreate] === "undefined"
        ) {
